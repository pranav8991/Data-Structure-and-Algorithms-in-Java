...
Here we can see the while loop will run as long as n1, n2, or c is non-zero. And in each iteration what operation are we performing? 
Division. Hence it might be logarithmic. Clearly, the loop will run at least the number of digits of the maximum number. 
Why maximum? Because we always look for the upper bound. There might be one extra for the carry.
